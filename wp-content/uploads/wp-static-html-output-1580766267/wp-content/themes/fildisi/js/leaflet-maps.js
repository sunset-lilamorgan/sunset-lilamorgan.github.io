	...
	var Map = {
		...
		map: function(){
			$('.eut-map').each( function() {
				...
				var tileOptions = {
					subdomains: fildisi_eutf_maps_data.map_tile_url_subdomains,
					attribution: fildisi_eutf_maps_data.map_tile_attribution
				};
				L.tileLayer( fildisi_eutf_maps_data.map_tile_url, tileOptions ).addTo(lmap);
